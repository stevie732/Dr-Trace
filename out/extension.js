...
function activate(context) {
    const timeTracker = new timeTracker_1.default();
    let startCommand = vscode.commands.registerCommand('timeTracker.start', () => {
        timeTracker.startTracking();
        vscode.window.showInformationMessage('Time tracking started.');
    });
    let stopCommand = vscode.commands.registerCommand('timeTracker.stop', () => {
